        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/crimsonbraixen/pokeapp/")
                    ...
                    developers {
                        developer {
                            id.set("crimsonbraixen")
                            name.set("crimsonbraixen")
                        }
                    }
                    scm {
                        connection.set("scm:git:git://github.com/crimsonbraixen/pokeapp.git")
                        developerConnection.set("scm:git:ssh://github.com/crimsonbraixen/pokeapp.git")
                        url.set("https://github.com/crimsonbraixen/pokeapp/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/crimsonbraixen/pokeapp/issues")
                    }
                }
            }
        }
